...
public class Profile extends Serialized {
    ...
    /**
     * Returns this profile's first and last name joined with a single space.
     *
     ...
     * {@inheritDoc}
     *
     * @return this profile's email address and full name, in that order, with the email address as the {@link #primaryKey()}
     */
    @Override
